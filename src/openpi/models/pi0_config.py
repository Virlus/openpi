...
if TYPE_CHECKING:
    ...
    from openpi.models.pi0_value import Pi0SuffixValue, Pi0PrefixValue
    from openpi.models.pi0_value_expert import Pi0ValueExpert
...
@dataclasses.dataclass(frozen=True)
class Pi0SuffixValueConfig(_model.BaseModelConfig):
    dtype: str = "bfloat16"
    paligemma_variant: _gemma.Variant = "gemma_2b"
    ...
    def model_type(self) -> _model.ModelType:
        if self.pi05:
            return _model.ModelType.PI05_SUFFIX_VALUE
        return _model.ModelType.PI0_SUFFIX_VALUE
    ...
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0SuffixValue":
        from openpi.models.pi0_value import Pi0SuffixValue

        return Pi0SuffixValue(self, rngs=nnx.Rngs(rng))
...
@dataclasses.dataclass(frozen=True)
class Pi0PrefixValueConfig(_model.BaseModelConfig):
    dtype: str = "bfloat16"
    paligemma_variant: _gemma.Variant = "gemma_2b"
    value_variant: _gemma.Variant = "gemma_2b"
    action_expert_variant: _gemma.Variant = "gemma_300m"
    ...
    def model_type(self) -> _model.ModelType:
        if self.pi05:
            return _model.ModelType.PI05_PREFIX_VALUE
        return _model.ModelType.PI0_PREFIX_VALUE
    ...
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0PrefixValue":
        from openpi.models.pi0_value import Pi0PrefixValue

        return Pi0PrefixValue(self, rngs=nnx.Rngs(rng))
...
class Pi0ValueExpertConfig(_model.BaseModelConfig):
    ...
    def model_type(self) -> _model.ModelType:
        if self.pi05:
            return _model.ModelType.PI05_VALUE_EXPERT
        return _model.ModelType.PI0_VALUE_EXPERT
    ...
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0ValueExpert":
        from openpi.models.pi0_value_expert import Pi0ValueExpert

        return Pi0ValueExpert(self, rngs=nnx.Rngs(rng))
