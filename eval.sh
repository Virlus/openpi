...
--output_path /data/yuwenye/reward_modeling/data/sarm/1122_original_kitchen_qwen3vl_reward_eval \
--reward_model_path /data/yuwenye/reward_modeling/output/qwen3vl_sarm/reward_model_99.pt \
